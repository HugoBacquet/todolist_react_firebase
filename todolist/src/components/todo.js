...
import { getTodos, addTodo, editTodo, deleteTodo, subscribeToNotifications } from '../store/actions/todoActions';
...
export default connect(mapStateToProps, { getTodos, addTodo, editTodo, deleteTodo, subscribeToNotifications })(withStyles(styles)(todo));